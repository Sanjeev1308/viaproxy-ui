...
export const RenderFormField = ({ field, form }: { field: any; form: any }) => {
          ...
          <Select
            onValueChange={(value) => {
              form.setValue(field.name, value, {
                shouldValidate: true, // This enables validation
                shouldDirty: true, // This marks the field as modified
              });
            }}
      ...
      return (
        <FormItem>
          ...
          <FormControl>
            <Textarea
              placeholder={field.placeholder}
              className={cn('resize-none', { 'border-destructive': error })}
              {...form.register(field.name)}
              // {...field}
            />
          </FormControl>
